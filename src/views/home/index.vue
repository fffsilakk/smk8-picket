...
<template>
  <aside
    id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen pl-3 pt-20 mt-5 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
    aria-label="Sidebar"
  >
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        ...
        <router-link :to="{ name: 'Picket-guru' }">
          <li>
            <span
              class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
            >
              ...
              <span class="ms-3">Jadwal picket guru</span>
            </span>
          </li>
        </router-link>
  ...
  <div class="container mt-5">
    <ul class="pt-60 timeline timeline-vertical">
      <li>
        ...
        <div class="timeline-end timeline-box">Daftar Guru</div>
        <hr />
      </li>
      <li>
        <hr />
        ...
        <div class="timeline-end timeline-box">Daftar Siswa</div>
        <hr />
      </li>
      <li>
        <hr />
        ...
        <div class="timeline-end timeline-box">Siswa</div>
        <hr />
      </li>
      <li>
        <hr />
        ...
        <div class="timeline-end timeline-box">Guru</div>
        <hr />
      </li>
      <li>
        <hr />
        ...
        <div class="timeline-end timeline-box">History</div>
      </li>
    </ul>
  </div>
</template>
