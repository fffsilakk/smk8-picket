...
const confirmDelete = (department) => {
  DialogService.showDialog(`Apakah Anda yakin ingin menghapus jurusan ${department.name} ?`,
    department, 'warning', 3000, "Batal", "Hapus").then(result => {
              ...
              <td class="px-6 py-4 flex gap-2">
                ...
                <button @click="confirmDelete(department)" class="text-white flex">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                    class="w-5 h-5 text-red-500 hover:text-red-800 dark:text-white ml-2" fill="currentColor">
                    <path
