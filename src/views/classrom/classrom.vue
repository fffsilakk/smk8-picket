...
export default {
  ...
  setup() {
    ...
    // Function to add classroom (POST)
...
<template>
  ...
  >
    <button
      ...
      class="transition rounded text-black my-3 w-6 items-center text-center"
    >
      <svg
        class="w-8 h-8 dark:text-white ml-2"
      ...
      <div class="modal-box">
        ...
        <form @submit.prevent="addClassroom">
          ...
          <div class="form-control">
            ...
            <input
              v-model="form.departmentInitial"
              class="input input-bordered"
              type="text"
              required
            />
          ...
          <div class="form-control">
            ...
            <select
              v-model="form.classRommLeaderId"
              class="input input-bordered"
              required
            >
