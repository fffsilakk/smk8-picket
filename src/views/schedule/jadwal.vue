...
<template>
  <div
    class="mt-12 m-auto pt-10 p-6 md:px-10 max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14"
  >
    <h2
    ...
    <div class="grid-cols-2 grid gap-3 sm:grid-cols-4 lg:grid-cols-2">
      <div v-for="item in dayOfWeeks" :key="item.name" class="grid">
        <div
          class="grid grid-cols-1 shadow-lg rounded-lg p-5 dark:bg-neutral-900"
        >
