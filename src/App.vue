          ...
          <div class="flex items-center justify-start rtl:justify-end">
            ...
            <router-link :to="{ name: 'home' }">
              <span class="flex ms-2 md:me-24">
                <img src="../public/smk.png" class="h-12 me-4" alt="Smk Logo" />
                <span
                  class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-black dark:text-white sm:inline hidden"
                  >Smk Negeri 8 Tik Jayapura</span
                >
              </span>
            </router-link>
          </div>
