<template>
   <div v-if="!isLoginPage">
      <aside style="background-image: url('/bgside.webp'); background-size: cover;" id="logo-sidebar" 
      class="fixed shadow-md shadow-gray-800 top-0 left-0 z-40 w-64 h-screen  transition-transform -translate-x-full 
